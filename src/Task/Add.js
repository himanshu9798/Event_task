...
class Div extends Component {
    ...
    add() {
        ...
        if (checked === true) {
            ...
            this.setState({ ans: `Addition of ${txt1} and ${txt2} is ${c}` });
        }
    ...
    render() {
        return (
            <div className="calculator-container">
                ...
                <span style={{ color: "red" ,fontSize:"small",float:"left",marginTop:"-15px"}}>{this.state.myerror.txt2}</span>

                <br /><br/>

                <input type="button" value="Add" style={{marginLeft:"90px"}} onClick={this.add.bind(this)} />
